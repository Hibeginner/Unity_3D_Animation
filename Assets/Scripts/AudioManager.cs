...
public class AudioManager : MonoBehaviour, IGameManager {
    ...
    public float musicVolume {
        get {return _musicVolum;}
        set {
            _musicVolum = value;
            if (music1Source != null && !_crossFading) {
                music1Source.volume = _musicVolum;
                music2Source.volume = _musicVolum;
            }
        }
    }
    ...
    private IEnumerator CrossFadeMusic(AudioClip clip) {
        ...
        float scaleRate = crossFadeRate * _musicVolum;
        ...
        _activeMusic.volume = _musicVolum;
        _inactiveMusic = temp;
        _inactiveMusic.Stop();
